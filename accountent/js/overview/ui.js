...
export const OverviewUI = {
    ...
    // REVERTED: Render Tanks as List (with circles)
    renderTanks: (containerId, tanksData) => {
        ...
        container.innerHTML = tanksData.map((tank, index) => {
            ...
            return `
            <div class="flex items-center gap-4 py-2 border-b border-gray-50 last:border-0 hover:bg-gray-50/50 p-2 rounded-xl transition-colors">
